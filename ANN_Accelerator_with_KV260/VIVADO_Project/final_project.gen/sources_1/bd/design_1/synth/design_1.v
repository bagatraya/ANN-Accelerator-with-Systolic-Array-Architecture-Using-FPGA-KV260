...
module design_1
  ...
  wire [127:0]axis_ann_0_m_axis_TDATA;
  wire axis_ann_0_m_axis_TLAST;
  wire axis_ann_0_m_axis_TREADY;
  wire axis_ann_0_m_axis_TVALID;
  ...
  design_1_axi_dma_0_0 axi_dma_0
       (.axi_resetn(proc_sys_reset_0_peripheral_aresetn),
        ...
        .s_axis_s2mm_tdata(axis_ann_0_m_axis_TDATA),
        .s_axis_s2mm_tkeep({1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1}),
        .s_axis_s2mm_tlast(axis_ann_0_m_axis_TLAST),
        .s_axis_s2mm_tready(axis_ann_0_m_axis_TREADY),
        .s_axis_s2mm_tvalid(axis_ann_0_m_axis_TVALID));
  design_1_axis_ann_0_0 axis_ann_0
       (.aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(proc_sys_reset_0_peripheral_aresetn),
        .m_axis_tdata(axis_ann_0_m_axis_TDATA),
        .m_axis_tlast(axis_ann_0_m_axis_TLAST),
        .m_axis_tready(axis_ann_0_m_axis_TREADY),
        .m_axis_tvalid(axis_ann_0_m_axis_TVALID),
  ...
  design_1_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
       (.maxigp0_araddr(zynq_ultra_ps_e_0_M_AXI_HPM0_FPD_ARADDR),
        ...
        .saxigp4_awaddr(smartconnect_2_M00_AXI_AWADDR),
        .saxigp4_awburst(smartconnect_2_M00_AXI_AWBURST),
        .saxigp4_awcache(smartconnect_2_M00_AXI_AWCACHE),
        .saxigp4_awid({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .saxigp4_awlen(smartconnect_2_M00_AXI_AWLEN),
        .saxigp4_awlock(smartconnect_2_M00_AXI_AWLOCK),
        .saxigp4_awprot(smartconnect_2_M00_AXI_AWPROT),
        .saxigp4_awqos(smartconnect_2_M00_AXI_AWQOS),
        .saxigp4_awready(smartconnect_2_M00_AXI_AWREADY),
        .saxigp4_awsize(smartconnect_2_M00_AXI_AWSIZE),
        .saxigp4_awuser(1'b0),
        .saxigp4_awvalid(smartconnect_2_M00_AXI_AWVALID),
        .saxigp4_bready(smartconnect_2_M00_AXI_BREADY),
        .saxigp4_bresp(smartconnect_2_M00_AXI_BRESP),
        .saxigp4_bvalid(smartconnect_2_M00_AXI_BVALID),
        .saxigp4_rready(1'b0),
        .saxigp4_wdata(smartconnect_2_M00_AXI_WDATA),
        .saxigp4_wlast(smartconnect_2_M00_AXI_WLAST),
        .saxigp4_wready(smartconnect_2_M00_AXI_WREADY),
        .saxigp4_wstrb(smartconnect_2_M00_AXI_WSTRB),
        .saxigp4_wvalid(smartconnect_2_M00_AXI_WVALID),
